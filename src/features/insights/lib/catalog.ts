/**
 * Insights feature — sample jobs, events, and hobby options for recommendations.
 */

import type { DreamJob } from "../types";

/** Sample dream job listings for the recommendations and dream-jobs flows. */
...
/** Sample events and projects for the recommendations page. */
...
/** Hobby options for the report card insights section. */
