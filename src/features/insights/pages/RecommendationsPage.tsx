/**
 * Insights feature — personalized job and event recommendations.
 *
 * Exports: RecommendationsPage (default)
 * Depends on: @/shared/app-state/AppContext, @/features/insights/lib/catalog, BottomNav
 */
...
import { SAMPLE_JOBS, SAMPLE_EVENTS } from "@/features/insights/lib/catalog";
